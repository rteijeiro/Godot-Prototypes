...
@onready var _crosshair := preload("res://2D/shooting_gallery/resources/stall/crosshair_outline_large.png")
# The target scene.
@onready var Target := preload("res://2D/shooting_gallery/target/target.tscn")

...
@onready var CharacterBlue := preload("res://2D/shape_characters/characters/character_blue.tscn")
@onready var CharacterGreen := preload("res://2D/shape_characters/characters/character_green.tscn")
@onready var CharacterPink := preload("res://2D/shape_characters/characters/character_pink.tscn")
@onready var CharacterPurple := preload("res://2D/shape_characters/characters/character_purple.tscn")
@onready var CharacterRed := preload("res://2D/shape_characters/characters/character_red.tscn")
@onready var CharacterYellow := preload("res://2D/shape_characters/characters/character_yellow.tscn")
